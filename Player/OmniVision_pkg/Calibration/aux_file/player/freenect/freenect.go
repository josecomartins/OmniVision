...
func SetAutoExposureOff(kinectDevice *FreenectDevice) {
	//adding auto exposure OFF code here
	C.freenect_set_flag(kinectDevice, C.FREENECT_AUTO_EXPOSURE, C.FREENECT_OFF)
	C.freenect_set_flag(kinectDevice, C.FREENECT_AUTO_WHITE_BALANCE, C.FREENECT_OFF)
	C.freenect_set_flag(kinectDevice, C.FREENECT_RAW_COLOR, C.FREENECT_OFF)
